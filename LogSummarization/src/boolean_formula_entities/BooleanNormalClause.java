...
/**
 * either a boolean conjunctive or disjunctive clause
 * a hash set of boolean literals that are either conjunctive or disjunctive
 * once created it should not be modified and its content will be turned into its simplest form, 
