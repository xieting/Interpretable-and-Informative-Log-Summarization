...
public class TautologyRegularizer{
	...
	private static int tautologyCheck(Expression exp){
		if (exp instanceof BinaryExpression){
			...
			MinorThanEquals eq1=new MinorThanEquals();
			eq1.setLeftExpression(innerleft);
			eq1.setRightExpression(left);
			MinorThanEquals eq2=new MinorThanEquals();
			eq2.setLeftExpression(left);
			eq2.setRightExpression(innerright);
